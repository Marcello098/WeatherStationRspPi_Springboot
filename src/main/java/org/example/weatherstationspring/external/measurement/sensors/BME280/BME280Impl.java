...
import org.example.weatherstationspring.external.measurement.helpers.Utils;
...
import static one.microproject.rpi.hardware.gpio.sensors.impl.Utils.*;
...
// Implementation of BME280 Interface
public class BME280Impl implements BME280 {
    ...
    public Data getSensorValues() {
        ...
        float[] floats = Utils.compensateDataBME280(data, digT1, digT2, digT3,
